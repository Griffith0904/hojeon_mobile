...
import V_appr_show_line from './project_src/ApprovalActivity/V_apprv_show_line'
...
export default class App extends Component {
  constructor(props) {
    ...
    this.ref_CustomSideBar = React.createRef();
  ...
  runLogout() {
    this.ref_CustomSideBar.navigate('login');
  }
  ...
  render() {
    const CustomSideBar = (props) => {
      this.ref_CustomSideBar = props.navigation
      return (<M_sidebar navigation={props.navigation} LogoutQuestion={this.logoutQuestion} />)
    } 
     
    /* 헤더는 잘됨
    const stn_appr_waitting = createStackNavigator(
      {
        listup: {
    ...
    */
    ...
    const V_main = (props) => {
      this.ref_CustomSideBar = props.navigation
      return (<V_ms navigation={props.navigation} LogoutQuestion={this.logoutQuestion} />)
    }
